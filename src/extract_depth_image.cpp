...
class DepthTopicExtractor : public rclcpp::Node
{
public:
    DepthTopicExtractor() : Node("depth_topic_extractor")
    {
...
int main(int argc, char** argv)
{
	...
	auto node = std::make_shared<DepthTopicExtractor>();
    node->extract();
